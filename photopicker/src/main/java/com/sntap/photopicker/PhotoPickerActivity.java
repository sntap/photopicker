...
public class PhotoPickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mode == MODE_MULTI) {
            ...
            getSupportActionBar().setTitle(languageList.get(4));
        }
...
//        mImageAdapter = new ImageGridAdapter(mCxt, mIsShowCamera, getItemImageWidth());
        mImageAdapter = new ImageGridAdapter(mCxt, mIsShowCamera, getItemImageWidth(),languageList.get(3));
        // 是否显示选择指示器
...
//                            btnAlbum.setText(R.string.all_image);
                            ...
                            btnAlbum.setText(languageList.get(1));
    ...
    private void refreshActionStatus(){
        ...
        String text = languageList.get(2)+getString(R.string.done_with_count, resultList.size(), mDesireImageCount);
