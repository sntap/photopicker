...
//    }
    ...
    public ImageGridAdapter(Context context, boolean showCamera, int itemSize,String cameraName){
        mContext = context;
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.showCamera = showCamera;
        this.mItemSize = itemSize;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(type == TYPE_CAMERA){
            ...
            TextView tv_camert = (TextView)view.findViewById(R.id.tv_camera);
            tv_camert.setText(cameraName);
